...
int nCoinbaseMaturity = 52; // 52 Confirmations
...
const string strMessageMagic = "Bergco Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);  // 64.86% Annual interest 
    if (pindexBest->nHeight < 2000)
    {
        nSubsidy = 0.01 * COIN;
    }
    ...
    else if (pindexBest->nHeight < 92000)
    {
...
static int64_t nTargetTimespan = 20 * 60;  // 20 minutes for the timespan to adjust
