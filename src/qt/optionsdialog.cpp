...
#endif
{
    ...
    ui->unit->setModel(new BergcoUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->bergcoAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Bergco."), QMessageBox::Ok);
