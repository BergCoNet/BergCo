...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Bergco.lnk";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart)
    {
        ...
        // Get a pointer to the IBergcoLink interface.
        IShellLink* psl = NULL;
        ...
        if (SUCCEEDED(hres))
        {
            ...
            // Query IBergcoLink for the IPersistFile interface for
...
{
    return GetAutostartDir() / "bergco.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Bergco-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  bergco-qt [" + tr("command-line options") + "]                     " + "\n";
