...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeBergcoAmount"))
        settings.setValue("nAnonymizeBergcoAmount", 1000);
    ...
    if (settings.contains("nAnonymizeBergcoAmount"))
        SoftSetArg("-anonymizeBergcoamount", settings.value("nAnonymizeBergcoAmount").toString().toStdString());
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeBergcoAmount:
            nAnonymizeBergcoAmount = value.toInt();
            settings.setValue("nAnonymizeBergcoAmount", nAnonymizeBergcoAmount);
            emit anonymizeBergcoAmountChanged(nAnonymizeBergcoAmount);
            break;
#ifdef USE_NATIVE_I2P
        case I2PUseI2POnly:
        {
