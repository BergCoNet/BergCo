/*
 * Qt5 bitoin/bergco GUI.
 * The Bergco Developer 2018
 * W.J. van der Laan 2011-2012
 * The Bergco Developers 2011-2012
 */
...
BergcoGUI::BergcoGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("BergCo") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/bergco"));
    setWindowIcon(QIcon(":icons/bergco"));
#else
...
void BergcoGUI::createActions()
{
    QActionGroup *tabGroup = new QActionGroup(this);

    overviewAction = new QAction(QIcon(":/icons/bergco1"), tr("&Dashboard"), this);
    overviewAction->setToolTip(tr("Show general overview of wallet"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/bergco1"), tr("&Receive"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(receiveCoinsAction);

    sendCoinsAction = new QAction(QIcon(":/icons/bergco1"), tr("&Send"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a Bergco address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(sendCoinsAction);

    historyAction = new QAction(QIcon(":/icons/bergco1"), tr("&Transactions"), this);
    historyAction->setToolTip(tr("Browse transaction history"));
    historyAction->setCheckable(true);
    historyAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_4));
    tabGroup->addAction(historyAction);

    addressBookAction = new QAction(QIcon(":/icons/bergco1"), tr("&Addresses"), this);
    addressBookAction->setToolTip(tr("Edit the list of stored addresses and labels"));
    addressBookAction->setCheckable(true);
    addressBookAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    tabGroup->addAction(addressBookAction);

    masternodeManagerAction = new QAction(QIcon(":/icons/bergco1"), tr("&Masternodes"), this);
    masternodeManagerAction->setToolTip(tr("Show Master Nodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    messageAction = new QAction(QIcon(":/icons/bergco1"), tr("&Messages"), this);
    messageAction->setToolTip(tr("View and Send Encrypted messages"));
    messageAction->setCheckable(true);
    tabGroup->addAction(messageAction);

    blockAction = new QAction(QIcon(":/icons/bergco1"), tr("&Block Explorer"), this);
    ...
    aboutAction = new QAction(tr("&About Bergco Coin"), this);
    aboutAction->setToolTip(tr("Show information about Bergco"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Bergco"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bergco"), tr("&Show / Hide"), this);
...
void BergcoGUI::setClientModel(ClientModel *clientModel)
{
    if(!fOnlyTor)
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/bergco_testnet"));
            setWindowIcon(QIcon(":icons/bergco_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/bergco_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Bergco client") + QString(" ") + tr("[testnet]"));
...
void BergcoGUI::setWalletModel(WalletModel *walletModel)
{
...
void BergcoGUI::setMessageModel(MessageModel *messageModel)
{
...
void BergcoGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Bergco client"));
...
#ifndef Q_OS_MAC
void BergcoGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
#ifdef USE_NATIVE_I2P
void BergcoGUI::showGeneratedI2PAddr(const QString& caption, const QString& pub, const QString& priv, const QString& b32, const QString& configFileName)
{
...
#ifdef USE_NATIVE_I2P
void BergcoGUI::setNumI2PConnections(int count)
{
    QString i2pIcon;
    switch(count)
    {
    ...
    labelI2PConnections->setToolTip(tr("%n active connection(s) to I2P-Bergco network", "", count));
}
#endif

void BergcoGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bergco network", "", count));
}

void BergcoGUI::setNumBlocks(int count)
{
    QString tooltip;
...
void BergcoGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("Bergco") + " - ";
...
void BergcoGUI::changeEvent(QEvent *e)
{
...
void BergcoGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void BergcoGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BergcoUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void BergcoGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(BergcoUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void BergcoGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void BergcoGUI::gotoMasternodeManagerPage()
{
...
void BergcoGUI::gotoBlockBrowser()
{
...
void BergcoGUI::gotoOverviewPage()
{
...
void BergcoGUI::gotoHistoryPage()
{
...
void BergcoGUI::gotoAddressBookPage()
{
...
void BergcoGUI::gotoReceiveCoinsPage()
{
...
void BergcoGUI::gotoSendCoinsPage()
{
...
void BergcoGUI::gotoSignMessageTab(QString addr)
{
...
void BergcoGUI::gotoVerifyMessageTab(QString addr)
{
...
void BergcoGUI::gotoMessagePage()
{
...
void BergcoGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void BergcoGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Bergco address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void BergcoGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void BergcoGUI::setEncryptionStatus(int status)
{
...
void BergcoGUI::changePassphrase()
{
...
void BergcoGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void BergcoGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void BergcoGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void BergcoGUI::updateStakingIcon()
{
    updateWeight();
