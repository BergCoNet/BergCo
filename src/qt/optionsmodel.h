...
/** Interface from Qt to configuration data structure for Bergco client.
...
public:
    ...
    enum OptionID {
        ...
        DisplayUnit,       // BergcoUnits::Unit
        Language,          // QString
        CoinControlFeatures, // bool
        MinimizeCoinAge,   // bool
        UseBlackTheme,     // bool
        DarksendRounds,    // int
        anonymizeBergcoAmount, //int
...
signals:
    ...
    void anonymizeBergcoAmountChanged(int);
};
