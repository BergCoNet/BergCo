...
/**
  Bergco GUI main class. This class represents the main window of the Bergco UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BergcoGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit BergcoGUI(QWidget *parent = 0);
    ~BergcoGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bergco wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
