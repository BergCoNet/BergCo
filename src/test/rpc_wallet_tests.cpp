// Copyright (c) 2013-2014 The Bergco Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CBergcoAddress demoAddress = CBergcoAddress(CTxDestination(demoPubkey.GetID()));
    UniValue retValue;
    ...
    CBergcoAddress setaccountDemoAddress = CBergcoAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CBergcoAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBergcoAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
