...
{
    BOOST_CHECK(TestSplitHost("www.bergco.org", "www.bergco.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bergco.org]", "www.bergco.org", -1));
    BOOST_CHECK(TestSplitHost("www.bergco.org:80", "www.bergco.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bergco.org]:80", "www.bergco.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:12088", "127.0.0.1", 12088));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:12088", "127.0.0.1", 12088));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:12088", "::ffff:127.0.0.1", 12088));
    BOOST_CHECK(TestSplitHost("[::]:12088", "::", 12088));
    BOOST_CHECK(TestSplitHost("::12088", "::12088", -1));
    BOOST_CHECK(TestSplitHost(":12088", "", 12088));
    BOOST_CHECK(TestSplitHost("[]:12088", "", 12088));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:12088", "127.0.0.1:12088"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:12088", "[::]:12088"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
