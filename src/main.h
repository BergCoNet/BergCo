...
#ifndef BERGCO_MAIN_H
#define BERGCO_MAIN_H
...
#define START_MASTERNODE_PAYMENTS_TESTNET 1569412800 // Wednesday, 25 September 2019 12:00:00
#define START_MASTERNODE_PAYMENTS 1569844800 // Monday, 30 September 2019 12:00:00
...
#define MASTERNODE_MIN_CONFIRMATIONS           4
...
static const unsigned int DEFAULT_MAX_ORPHAN_BLOCKS = 400;
/** The maximum number of entries in an 'inv' protocol message */
static const unsigned int MAX_INV_SZ = 50000;
/** Fees smaller than this (in satoshi) are considered zero fee (for transaction creation) */
static const int64_t MIN_TX_FEE = 30000; // 0.0003 per kb
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying) */
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = 200000000 * COIN; // 200 Million
/** This is the amount in % to which is returned yearly in interest */
static const int64_t COIN_YEAR_REWARD = 64.86 * CENT; // 64.86% Per Year
/** This is the block target time for PoW/PoS mining */
static const int64_t TARGET_SPACING = 52; // 52 second block times expected
...
static const int64_t DRIFT = 300; // 3 minute drift time
...
public:
    ...
    /** Amount of bergcos spent by this transaction.
    ...
    /** Amount of bergcos coming in to this transaction
