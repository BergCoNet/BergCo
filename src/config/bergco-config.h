/* src/bergco-config.h.  Generated from bergco-config.h.in by configure.  */
/* src/bergco-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BERGCO_CONFIG_H

#define BERGCO_CONFIG_H
...
#define PACKAGE_BUGREPORT "support@bergco.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bergco"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bergco 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bergco"
